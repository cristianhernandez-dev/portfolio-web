  ...
  const projects = [
    {
      ...
      (
  <>
    Aplicación desarrollada con Vue.js para visualizar productos, filtrar contenido, 
    marcar favoritos y revisar detalles mediante una interfaz limpia y dinámica.{" "}
    <strong>Impacto:</strong> La migración a una API más estable redujo errores de carga 
    y mejoró la disponibilidad de datos en la aplicación.
  </>
),
